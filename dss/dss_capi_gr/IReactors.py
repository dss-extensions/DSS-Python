...
class IReactors(Base):
    ...
    def Rmatrix(self):
        ...
        self._lib.Reactors_Get_Rmatrix_GR()
    ...
    def Xmatrix(self):
        ...
        self._lib.Reactors_Get_Xmatrix_GR()
        return self._get_float64_gr_array()
