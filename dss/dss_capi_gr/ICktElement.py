...
class ICktElement(Base):
    ...
    def AllVariableValues(self):
        ...
        self._lib.CktElement_Get_AllVariableValues_GR()
    ...
    def Losses(self):
        ...
        self._lib.CktElement_Get_Losses_GR()
        return self._get_float64_gr_array()
