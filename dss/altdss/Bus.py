...
class Bus:
    ...
    def CustDuration(self) -> float:
        ...
        return self._lib.Alt_Bus_Get_Cust_Duration(self._ptr)

    @property
    def CustInterrupts(self) -> float:
        '''Annual number of customer-interruptions from this bus.'''
        return self._lib.Alt_Bus_Get_Cust_Interrupts(self._ptr)
    ...
    def IntDuration(self) -> float:
        ...
        return self._lib.Alt_Bus_Get_Int_Duration(self._ptr)
    ...
    def Loads(self) -> LoadBatch:
        ...
        return LoadBatch(from_func=(self._lib.Alt_Bus_Get_Loads, self._ptr))
    
    def Lines(self) -> LineBatch:
        '''Batch of line objects connected to this bus.'''
        return LineBatch(from_func=(self._lib.Alt_Bus_Get_Lines, self._ptr))
...
class BusBatch(Base):
    ...
    def IntDuration(self) -> Float64Array:
        ...
        return self._busbatch_float64('Alt_Bus_Get_Int_Duration')
