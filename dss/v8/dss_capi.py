...
class ISolution(Base):
    ...
    @property
    def BusLevels(self):
        lib.Solution_Get_BusLevels_GR()
        return get_int32_gr_array()

    @property
    def IncMatrix(self):
        lib.Solution_Get_IncMatrix_GR()
        return get_int32_gr_array()
...
class IParallel(Base):
    ...
    def ActorProgress(self):
        ...
        lib.Parallel_Get_ActorProgress_GR()
        return get_int32_gr_array()

    @property
    def ActorStatus(self):
        '''(read-only) Gets the status of each actor'''
        lib.Parallel_Get_ActorStatus_GR()
        return get_int32_gr_array()
