...
class IStorages(Iterable):
    ...
    def AmpLimit(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_AmpLimit())

    @AmpLimit.setter
    def AmpLimit(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_AmpLimit(Value))
    ...
    def AmpLimitGain(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_AmpLimitGain())

    @AmpLimitGain.setter
    def AmpLimitGain(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_AmpLimitGain(Value))
    ...
    def ChargeTrigger(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_ChargeTrigger())

    @ChargeTrigger.setter
    def ChargeTrigger(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_ChargeTrigger(Value))
    ...
    def ControlMode(self) -> int:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_ControlMode())

    @ControlMode.setter
    def ControlMode(self, Value: int) -> None:
        self._check_for_error(self._lib.Storages_Set_ControlMode(Value))
    ...
    def DischargeTrigger(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_DischargeTrigger())

    @DischargeTrigger.setter
    def DischargeTrigger(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_DischargeTrigger(Value))
    ...
    def EffCharge(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_EffCharge())

    @EffCharge.setter
    def EffCharge(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_EffCharge(Value))
    ...
    def EffDischarge(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_EffDischarge())

    @EffDischarge.setter
    def EffDischarge(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_EffDischarge(Value))
    ...
    def Kp(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_Kp())

    @Kp.setter
    def Kp(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_Kp(Value))
    ...
    def kV(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_kV())

    @kV.setter
    def kV(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_kV(Value))
    ...
    def kVA(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_kVA())

    @kVA.setter
    def kVA(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_kVA(Value))
    ...
    def kvar(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_kvar())

    @kvar.setter
    def kvar(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_kvar(Value))
    ...
    def kVDC(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_kVDC())

    @kVDC.setter
    def kVDC(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_kVDC(Value))
    ...
    def kW(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_kW())

    @kW.setter
    def kW(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_kW(Value))
    ...
    def kWhRated(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_kWhRated())

    @kWhRated.setter
    def kWhRated(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_kWhRated(Value))
    ...
    def kWRated(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_kWRated())

    @kWRated.setter
    def kWRated(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_kWRated(Value))
    ...
    def LimitCurrent(self) -> bool:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_LimitCurrent()) != 0

    @LimitCurrent.setter
    def LimitCurrent(self, Value: bool) -> None:
        self._check_for_error(self._lib.Storages_Set_LimitCurrent(Value))
    ...
    def PF(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_PF())

    @PF.setter
    def PF(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_PF(Value))
    ...
    def PITol(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_PITol())

    @PITol.setter
    def PITol(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_PITol(Value))
    ...
    def SafeMode(self) -> int:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_SafeMode())
    ...
    def SafeVoltage(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_SafeVoltage())

    @SafeVoltage.setter
    def SafeVoltage(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_SafeVoltage(Value))
    ...
    def TimeChargeTrig(self) -> float:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_TimeChargeTrig())

    @TimeChargeTrig.setter
    def TimeChargeTrig(self, Value: float) -> None:
        self._check_for_error(self._lib.Storages_Set_TimeChargeTrig(Value))
    ...
    def VarFollowInverter(self) -> int:
        ...
        '''
        return self._check_for_error(self._lib.Storages_Get_VarFollowInverter())

    @VarFollowInverter.setter
    def VarFollowInverter(self, Value: int) -> None:
        self._check_for_error(self._lib.Storages_Set_VarFollowInverter(Value))
