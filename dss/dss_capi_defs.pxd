from libc.stdint cimport int32_t, uint32_t, uint16_t, int8_t

cdef extern from "dss_capi.h":
    ...
    void ActiveClass_Get_AllNames_GR()
    ...
    void Bus_Get_CplxSeqVoltages_GR()
    ...
    void CapControls_Get_AllNames_GR()
    ...
    void Circuit_Get_AllBusVmagPu_GR()
    ...
    void CktElement_Get_BusNames_GR()
    ...
    void CktElement_Get_NodeOrder_GR()
    ...
    void CktElement_Get_CurrentsMagAng_GR()
    void CktElement_Get_VoltagesMagAng(double** ResultPtr, int32_t* ResultCount)
    void CktElement_Get_VoltagesMagAng_GR()
    ...
    void Generators_Get_AllNames_GR()
    ...
    void Generators_Get_RegisterNames_GR()
    void Generators_Get_RegisterValues(double** ResultPtr, int32_t* ResultCount)
    void Generators_Get_RegisterValues_GR()
    ...
    void LoadShapes_Get_TimeArray_GR()
    ...
    void Meters_Get_CalcCurrent_GR()
    ...
    void Meters_Get_AllocFactors_GR()
    ...
    void Meters_Get_AllEndElements_GR()
    ...
    void Meters_Get_AllBranchesInZone_GR()
    ...
    void Monitors_Get_ByteStream_GR()
    ...
    void Reclosers_Get_AllNames_GR()
    ...
    void Reclosers_Get_RecloseIntervals_GR()
    ...
    void RegControls_Get_AllNames_GR()
    ...
    void Settings_Get_VoltageBases_GR()
    ...
    void SwtControls_Get_AllNames_GR()
    ...
    void Topology_Get_AllIsolatedBranches_GR()
    void Topology_Get_AllLoopedPairs(char*** ResultPtr, int32_t* ResultCount)
    void Topology_Get_AllLoopedPairs_GR()
    ...
    void Topology_Get_AllIsolatedLoads_GR()
    ...
    void Transformers_Get_AllNames_GR()
    ...
    int32_t LineGeometries_Get_Count()
    int32_t LineGeometries_Get_First()
    int32_t LineGeometries_Get_Next()
    char* LineGeometries_Get_Name()
    void LineGeometries_Set_Name(char* Value)
    int32_t LineGeometries_Get_Nconds()
    void LineGeometries_Set_Nconds(int32_t Value)
    int32_t LineGeometries_Get_Phases()
    ...
    void LineGeometries_Get_Units_GR()
    ...
    void LineGeometries_Get_Xcoords_GR()
    ...
    void LineGeometries_Get_Ycoords_GR()
    ...
    void LineSpacings_Get_Ycoords_GR()
