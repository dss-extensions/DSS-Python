#TODO: consider https://gist.github.com/GaelVaroquaux/1249305
import numpy as np
from cython cimport view
cimport dss_capi_defs as lib
cimport numpy as np
codec = 'ascii'

cdef char ***gr_data_string;
cdef double **gr_data_float64;
cdef lib.int32_t **gr_data_int32;
cdef lib.int8_t **gr_data_int8;

cdef lib.int32_t *gr_count_string = [0, 0]
cdef lib.int32_t *gr_count_float64 = [0, 0]
cdef lib.int32_t *gr_count_int32 = [0, 0]
cdef lib.int32_t *gr_count_int8 = [0, 0]

lib.DSS_GetGRPointers(
    &gr_data_string,
    &gr_data_float64,
    &gr_data_int32,
    &gr_data_int8,
...
cdef get_float64_gr_array():
    if gr_count_float64[0] == 0: return np.zeros((0,), dtype=np.float64)
    
    cdef view.array data = <np.float64_t[:gr_count_float64[0]]> gr_data_float64[0]
    return np.asarray(data)
    
cdef get_int32_gr_array():
    if gr_count_int32[0] == 0: return np.zeros((0,), dtype=np.int32)
    
    cdef view.array data = <np.int32_t[:gr_count_int32[0]]> gr_data_int32[0]
    return np.asarray(data)
    
cdef get_int8_gr_array():
    if gr_count_int8[0] == 0: return np.zeros((0,), dtype=np.int8)

    cdef view.array data = <np.int8_t[:gr_count_int32[0]]> gr_data_int8[0]
    return np.asarray(data)
...
def CheckForError():
    ...
    if error_num:
        raise DssException(error_num, lib.Error_Get_Description().decode(codec))
...
class IActiveClass:
    ...
    def ActiveClassName(self):
        ...
        return lib.ActiveClass_Get_ActiveClassName().decode(codec)
    ...
    def Name(self):
        ...
        return lib.ActiveClass_Get_Name().decode(codec)
...
class IBus:
    ...
    def Name(self):
        ...
        return lib.Bus_Get_Name().decode(codec)
...
class ICapacitors:
    ...
    def Name(self):
        ...
        return lib.Capacitors_Get_Name().decode(codec)
    ...
    @States.setter
    def States(self, np.ndarray[np.int32_t, ndim=1] Value):
        lib.Capacitors_Set_States(&Value[0], Value.shape[0])
...
class ICapControls:
    ...
    def Capacitor(self):
        ...
        return lib.CapControls_Get_Capacitor().decode(codec)
    ...
    def MonitoredObj(self):
        ...
        return lib.CapControls_Get_MonitoredObj().decode(codec)
    ...
    def Name(self):
        ...
        return lib.CapControls_Get_Name().decode(codec)
...
class IDSSProperty:
    ...
    def Description(self):
        ...
        return lib.DSSProperty_Get_Description().decode(codec)

    @property
    def Name(self):
        '''(read-only) Name of Property'''
        return lib.DSSProperty_Get_Name().decode(codec)

    @property
    def Val(self):
        return lib.DSSProperty_Get_Val().decode(codec)
...
class IDSS_Executive:
    def Command(self, i):
        '''(read-only) Get i-th command'''
        return lib.DSS_Executive_Get_Command(i).decode(codec)

    def CommandHelp(self, i):
        '''(read-only) Get help string for i-th command'''
        return lib.DSS_Executive_Get_CommandHelp(i).decode(codec)

    def Option(self, i):
        '''(read-only) Get i-th option'''
        return lib.DSS_Executive_Get_Option(i).decode(codec)

    def OptionHelp(self, i):
        '''(read-only) Get help string for i-th option'''
        return lib.DSS_Executive_Get_OptionHelp(i).decode(codec)

    def OptionValue(self, i):
        '''(read-only) Get present value of i-th option'''
        return lib.DSS_Executive_Get_OptionValue(i).decode(codec)
...
class IError:
    ...
    def Description(self):
        ...
        return lib.Error_Get_Description().decode(codec)
...
class IFuses:
    ...
    def MonitoredObj(self):
        ...
        return lib.Fuses_Get_MonitoredObj().decode(codec)
    ...
    def Name(self):
        ...
        '''
        return lib.Fuses_Get_Name().decode(codec)
    ...
    def SwitchedObj(self):
        ...
        '''
        return lib.Fuses_Get_SwitchedObj().decode(codec)
    ...
    def TCCcurve(self):
        ...
        return lib.Fuses_Get_TCCcurve().decode(codec)
...
class IGenerators:
    ...
    def Name(self):
        ...
        return lib.Generators_Get_Name().decode(codec)
...
class IISources:
    ...
    def Name(self):
        ...
        '''
        return lib.ISources_Get_Name().decode(codec)
...
class ILineCodes:
    ...
    @Cmatrix.setter
    def Cmatrix(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.LineCodes_Set_Cmatrix(&Value[0], Value.shape[0])
    ...
    def Name(self):
        ...
        return lib.LineCodes_Get_Name().decode(codec)
    ...
    @Rmatrix.setter
    def Rmatrix(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.LineCodes_Set_Rmatrix(&Value[0], Value.shape[0])
    ...
    @Xmatrix.setter
    def Xmatrix(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.LineCodes_Set_Xmatrix(&Value[0], Value.shape[0])
...
class ILines:
    ...
    def Bus1(self):
        ...
        return lib.Lines_Get_Bus1().decode(codec)
    ...
    def Bus2(self):
        ...
        return lib.Lines_Get_Bus2().decode(codec)
    ...
    @Cmatrix.setter
    def Cmatrix(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.Lines_Set_Cmatrix(&Value[0], Value.shape[0])
    ...
    def Geometry(self):
        '''Line geometry code'''
        return lib.Lines_Get_Geometry().decode(codec)
    ...
    def LineCode(self):
        ...
        return lib.Lines_Get_LineCode().decode(codec)
    ...
    def Name(self):
        ...
        return lib.Lines_Get_Name().decode(codec)
    ...
    @Rmatrix.setter
    def Rmatrix(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.Lines_Set_Rmatrix(&Value[0], Value.shape[0])

    @property
    def Spacing(self):
        '''Line spacing code'''
        return lib.Lines_Get_Spacing().decode(codec)
    ...
    @Xmatrix.setter
    def Xmatrix(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.Lines_Set_Xmatrix(&Value[0], Value.shape[0])
    ...
    @Yprim.setter
    def Yprim(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.Lines_Set_Yprim(&Value[0], Value.shape[0])
...
class ILoads:
    ...
    def CVRcurve(self):
        ...
        return lib.Loads_Get_CVRcurve().decode(codec)
    ...
    def Growth(self):
        ...
        return lib.Loads_Get_Growth().decode(codec)
    ...
    def Name(self):
        ...
        return lib.Loads_Get_Name().decode(codec)
    ...
    def Spectrum(self):
        ...
        return lib.Loads_Get_Spectrum().decode(codec)
    ...
    def Yearly(self):
        ...
        return lib.Loads_Get_Yearly().decode(codec)
    ...
    @ZIPV.setter
    def ZIPV(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.Loads_Set_ZIPV(&Value[0], Value.shape[0])

    @property
    def daily(self):
        '''Name of the loadshape for a daily load profile.'''
        return lib.Loads_Get_daily().decode(codec)
    ...
    def duty(self):
        ...
        return lib.Loads_Get_duty().decode(codec)
...
class ILoadShapes:
    ...
    def Name(self):
        ...
        '''
        return lib.LoadShapes_Get_Name().decode(codec)
    ...
    @Pmult.setter
    def Pmult(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.LoadShapes_Set_Pmult(&Value[0], Value.shape[0])
    ...
    @Qmult.setter
    def Qmult(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.LoadShapes_Set_Qmult(&Value[0], Value.shape[0])
    ...
    @TimeArray.setter
    def TimeArray(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.LoadShapes_Set_TimeArray(&Value[0], Value.shape[0])
...
class IMeters:
    ...
    @AllocFactors.setter
    def AllocFactors(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.Meters_Set_AllocFactors(&Value[0], Value.shape[0])
    ...
    @CalcCurrent.setter
    def CalcCurrent(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.Meters_Set_CalcCurrent(&Value[0], Value.shape[0])
    ...
    def MeteredElement(self):
        ...
        return lib.Meters_Get_MeteredElement().decode(codec)
    ...
    def Name(self):
        ...
        '''
        return lib.Meters_Get_Name().decode(codec)
    ...
    @Peakcurrent.setter
    def Peakcurrent(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.Meters_Set_Peakcurrent(&Value[0], Value.shape[0])
...
class IMonitors:
    ...
    def Element(self):
        ...
        return lib.Monitors_Get_Element().decode(codec)
    ...
    def FileName(self):
        ...
        return lib.Monitors_Get_FileName().decode(codec)
    ...
    def Name(self):
        ...
        return lib.Monitors_Get_Name().decode(codec)
...
class IParser:
    ...
    def BeginQuote(self):
        ...
        '''
        return lib.Parser_Get_BeginQuote().decode(codec)
    ...
    def CmdString(self):
        ...
        return lib.Parser_Get_CmdString().decode(codec)
    ...
    def Delimiters(self):
        ...
        return lib.Parser_Get_Delimiters().decode(codec)
    ...
    def EndQuote(self):
        ...
        return lib.Parser_Get_EndQuote().decode(codec)
    ...
    def NextParam(self):
        ...
        return lib.Parser_Get_NextParam().decode(codec)

    @property
    def StrValue(self):
        '''(read-only) Return next parameter as a string'''
        return lib.Parser_Get_StrValue().decode(codec)
    ...
    def WhiteSpace(self):
        ...
        '''
        return lib.Parser_Get_WhiteSpace().decode(codec)
...
class IPDElements:
    ...
    def Name(self):
        ...
        return lib.PDElements_Get_Name().decode(codec)
...
class IPVSystems:
    ...
    def Name(self):
        ...
        '''
        return lib.PVSystems_Get_Name().decode(codec)
...
class IReclosers:
    ...
    def MonitoredObj(self):
        ...
        '''
        return lib.Reclosers_Get_MonitoredObj().decode(codec)
    ...
    def Name(self):
        ...
        return lib.Reclosers_Get_Name().decode(codec)
    ...
    def SwitchedObj(self):
        ...
        return lib.Reclosers_Get_SwitchedObj().decode(codec)
...
class IRegControls:
    ...
    def MonitoredBus(self):
        ...
        return lib.RegControls_Get_MonitoredBus().decode(codec)
    ...
    def Name(self):
        ...
        '''
        return lib.RegControls_Get_Name().decode(codec)
    ...
    def Transformer(self):
        ...
        return lib.RegControls_Get_Transformer().decode(codec)
...
class IRelays:
    ...
    def MonitoredObj(self):
        ...
        return lib.Relays_Get_MonitoredObj().decode(codec)
    ...
    def Name(self):
        ...
        '''
        return lib.Relays_Get_Name().decode(codec)
    ...
    def SwitchedObj(self):
        ...
        return lib.Relays_Get_SwitchedObj().decode(codec)
...
class ISensors:
    ...
    @Currents.setter
    def Currents(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.Sensors_Set_Currents(&Value[0], Value.shape[0])
    ...
    def MeteredElement(self):
        ...
        return lib.Sensors_Get_MeteredElement().decode(codec)
    ...
    def Name(self):
        ...
        '''
        return lib.Sensors_Get_Name().decode(codec)
    ...
    @kVARS.setter
    def kVARS(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.Sensors_Set_kVARS(&Value[0], Value.shape[0])
    ...
    @kVS.setter
    def kVS(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.Sensors_Set_kVS(&Value[0], Value.shape[0])
    ...
    @kWS.setter
    def kWS(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.Sensors_Set_kWS(&Value[0], Value.shape[0])
...
class ISettings:
    ...
    def AutoBusList(self):
        ...
        return lib.Settings_Get_AutoBusList().decode(codec)
    ...
    @LossRegs.setter
    def LossRegs(self, np.ndarray[np.int32_t, ndim=1] Value):
        lib.Settings_Set_LossRegs(&Value[0], Value.shape[0])
    ...
    def PriceCurve(self):
        ...
        return lib.Settings_Get_PriceCurve().decode(codec)
    ...
    @UEregs.setter
    def UEregs(self, np.ndarray[np.int32_t, ndim=1] Value):
        lib.Settings_Set_UEregs(&Value[0], Value.shape[0])
    ...
    @VoltageBases.setter
    def VoltageBases(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.Settings_Set_VoltageBases(&Value[0], Value.shape[0])
...
class ISolution:
    ...
    def DefaultDaily(self):
        ...
        return lib.Solution_Get_DefaultDaily().decode(codec)
    ...
    def DefaultYearly(self):
        ...
        return lib.Solution_Get_DefaultYearly().decode(codec)
    ...
    def LDCurve(self):
        ...
        return lib.Solution_Get_LDCurve().decode(codec)
    ...
    def ModeID(self):
        ...
        return lib.Solution_Get_ModeID().decode(codec)
...
class ISwtControls:
    ...
    def Name(self):
        ...
        return lib.SwtControls_Get_Name().decode(codec)
    ...
    def SwitchedObj(self):
        ...
        return lib.SwtControls_Get_SwitchedObj().decode(codec)
...
class IText:
    ...
    def Command(self):
        ...
        return lib.Text_Get_Command().decode(codec)
    ...
    def Result(self):
        ...
        return lib.Text_Get_Result().decode(codec)
...
class ITopology:
    ...
    def BranchName(self):
        ...
        return lib.Topology_Get_BranchName().decode(codec)
    ...
    def BusName(self):
        ...
        return lib.Topology_Get_BusName().decode(codec)
...
class ITransformers:
    ...
    def Name(self):
        ...
        return lib.Transformers_Get_Name().decode(codec)
    ...
    def XfmrCode(self):
        ...
        return lib.Transformers_Get_XfmrCode().decode(codec)
...
class IVsources:
    ...
    def Name(self):
        ...
        '''
        return lib.Vsources_Get_Name().decode(codec)
...
class IXYCurves:
    ...
    def Name(self):
        ...
        '''
        return lib.XYCurves_Get_Name().decode(codec)
    ...
    @Xarray.setter
    def Xarray(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.XYCurves_Set_Xarray(&Value[0], Value.shape[0])
    ...
    @Yarray.setter
    def Yarray(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.XYCurves_Set_Yarray(&Value[0], Value.shape[0])
...
class ICktElement:
    ...
    def Controller(self, idx):
        ...
        return lib.CktElement_Get_Controller(idx).decode(codec)
    ...
    def DisplayName(self):
        ...
        return lib.CktElement_Get_DisplayName().decode(codec)
    ...
    def EnergyMeter(self):
        ...
        return lib.CktElement_Get_EnergyMeter().decode(codec)

    @property
    def GUID(self):
        '''(read-only) globally unique identifier for this object'''
        return lib.CktElement_Get_GUID().decode(codec)
    ...
    def Name(self):
        ...
        return lib.CktElement_Get_Name().decode(codec)
...
class IDSSElement:
    ...
    def Name(self):
        ...
        return lib.DSSElement_Get_Name().decode(codec)
...
class ILineSpacings:
    ...
    def Name(self):
        ...
        return lib.LineSpacings_Get_Name().decode(codec)
    ...
    @Xcoords.setter
    def Xcoords(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.LineSpacings_Set_Xcoords(&Value[0], Value.shape[0])
    ...
    @Ycoords.setter
    def Ycoords(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.LineSpacings_Set_Ycoords(&Value[0], Value.shape[0])
...
class ILineGeometries:
    ...
    def Name(self):
        ...
        return lib.LineGeometries_Get_Name().decode(codec)
    ...
    @Units.setter
    def Units(self, np.ndarray[np.int32_t, ndim=1] Value):
        lib.LineGeometries_Set_Units(&Value[0], Value.shape[0])
    ...
    @Xcoords.setter
    def Xcoords(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.LineGeometries_Set_Xcoords(&Value[0], Value.shape[0])
    ...
    @Ycoords.setter
    def Ycoords(self, np.ndarray[np.float64_t, ndim=1] Value):
        lib.LineGeometries_Set_Ycoords(&Value[0], Value.shape[0])
...
class IWireData:
    ...
    def Name(self):
        ...
        return lib.WireData_Get_Name().decode(codec)
...
class ICircuit:
    ...
    def Name(self):
        ...
        return lib.Circuit_Get_Name().decode(codec)
...
class IDSS:
    ...
    def DataPath(self):
        ...
        return lib.DSS_Get_DataPath().decode(codec)
    ...
    def DefaultEditor(self):
        ...
        return lib.DSS_Get_DefaultEditor().decode(codec)
    ...
    def Version(self):
        ...
        return lib.DSS_Get_Version().decode(codec)
